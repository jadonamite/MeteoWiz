...
const ImagerySection = () => {
   ...
   return (
      <div className="h-full flex flex-col gap-3">
         {/* First Card - Takes 50% of available space */}
         <div className="bg-gray-300 border-2 border-gray-400 rounded flex-1 flex flex-col">
            {/* Header */}
         ...
         {/* Second Card - Takes 50% of available space */}
         <div className="bg-gray-300 border-2 border-gray-400 rounded flex-1 flex flex-col">
            {/* Content */}
            <div className="p-3 space-y-3 flex-1 overflow-auto">
               {/* Display Type Selector */}

// app/components/ImagerySection.jsx
"use client";
          ...
          <div className="text-center mb-4">
            ...
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <div className="text-right">
                <div className="text-4xl font-bold">{imageryData.currentTemp}°C</div>
        ...
        <div className="bg-gradient-to-b from-blue-900 to-black rounded-lg p-4 text-white relative">
          ...
          <div className="flex items-center justify-between mt-6">
            <div>
              ...
              <div className="text-2xl font-bold">{imageryData.cityName}</div>
            </div>
            <div className="text-4xl font-bold">{imageryData.currentTemp}°C</div>
          </div>

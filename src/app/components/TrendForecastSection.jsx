  ...
  return (
    <div className="bg-white border-2 border-gray-400 rounded">
      ...
      <div className="bg-gray-300 border-b-2 border-gray-400 px-3 py-1.5">
        <h2 className="font-bold text-sm">TREND LANDING FORECAST FOR DNAS</h2>
      </div>
      ...
      <div className="p-3 space-y-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <label htmlFor="uncheck-edit" className="text-xs text-blue-600 underline cursor-pointer">
...
const ForecastInputRow = ({ label, value, onChange, secondLabel, secondValue, onSecondChange }) => (
  <div className="flex items-center gap-2">
